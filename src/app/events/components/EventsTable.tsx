        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full animate-fade-in">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#343A40] mb-2">Delete Event</h3>
        ...
        <table className="w-full table-fixed divide-y divide-gray-200">
          <thead className="bg-gradient-to-r from-[#007BFF]/5 to-[#007BFF]/10">
            <tr>
              ...
              <th className="w-[30%] px-6 py-4 text-left text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Location
              </th>
              <th className="w-[15%] px-6 py-4 text-left text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Actions
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {events.length === 0 ? (
              <tr>
                <td colSpan={5} className="px-6 py-8 text-center text-[#6C757D]">
                  No events found
                </td>
              </tr>
            ) : (
