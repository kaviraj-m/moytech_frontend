...
export default function EventForm({ onSubmit, editingEvent }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setNotificationMessage(editingEvent ? 'Event updated successfully!' : 'New event added successfully!');
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 mb-8 relative border border-gray-100">
      ...
      <div className="flex items-center mb-8">
        <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-4 ${editingEvent ? 'bg-[#007BFF]/10 text-[#007BFF]' : 'bg-[#28A745]/10 text-[#28A745]'}`}>
          {editingEvent ? (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium mb-2 text-[#343A40]">Event Name</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-[#343A40]">Event Type</label>
            <select
              name="event_type"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium mb-2 text-[#343A40]">Date</label>
            <input
              type="date"
              name="date"
              value={formData.date}
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-[#343A40]">Location</label>
            <input
              type="text"
              name="location"
