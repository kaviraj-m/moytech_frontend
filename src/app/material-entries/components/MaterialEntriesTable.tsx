...
export default function MaterialEntriesTable({ entries, onEdit, onDelete }: Props) {
      ...
      <div className="overflow-x-auto">
        <table className="w-full table-fixed divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="w-[15%] px-4 py-4 text-center text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Contributor
              </th>
              <th className="w-[12%] px-4 py-4 text-center text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Material Type
              </th>
              <th className="w-[10%] px-4 py-4 text-center text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Weight
              </th>
              <th className="w-[23%] px-4 py-4 text-center text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Description
              </th>
              <th className="w-[15%] px-4 py-4 text-center text-xs font-semibold text-[#343A40] uppercase tracking-wider border-b">
                Place
            ...
            {entries.length === 0 ? (
              ...
              entries.map(entry => (
                <tr key={entry.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-4 text-center text-sm text-[#343A40] truncate">
                    {entry.contributor_name}
                  </td>
                  <td className="px-4 py-4 text-center text-sm text-[#343A40]">
                    {entry.material_type}
                  </td>
                  <td className="px-4 py-4 text-center text-sm text-[#343A40]">
